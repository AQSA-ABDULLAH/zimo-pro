...
export default function Section5() {
  ...
  return (
    <div
      ref={sectionRef}
      className={`relative min-h-[750px] flex flex-col px-4 md:px-8 overflow-hidden transition-opacity duration-500 ${
    ...
    >
      ...
      <div className="z-10 text-white flex flex-col justify-between min-h-full">
        ...
        <div className="flex justify-end px-4 md:px-10 py-8 md:py-12">
          ...
          >
            <p className="text-[20px] md:text-[28px] max-w-[280px] md:max-w-[420px] mb-4 md:mb-5 font-medium leading-6 md:leading-8 tracking-widest">
        ...
        {/* Bottom Content */}
        <div
          className={`flex flex-col md:flex-row justify-between items-center mt-12 md:mt-28 px-4 md:px-10 transition-opacity duration-500 ${
        ...
        >
          ...
          />
          <p className="text-[14px] md:text-[16px] mt-6 md:mt-0 font-medium tracking-widest">
            CREATE USER ID
          </p>
        </div>
      </div>
