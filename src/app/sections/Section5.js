...
export default function Section5() {
  return (
    <div className="relative min-h-[750px] flex flex-col px-4 md:px-8 overflow-hidden">
      {/* Background Image */}
      <div
      ...
      <div className="z-10 text-white flex flex-col justify-between min-h-full">
        ...
        {/* Bottom Content */}
        <div className="flex flex-col md:flex-row justify-between items-center mt-12 md:mt-28 px-4 md:px-10">
          <img
