export default function Section6() {
  return (
      <div className="min-h-[650px] flex flex-col justify-center xl:text-center items-center relative px-8 overflow-hidden">
          ...
          <h4 className="tracking-[2px] text-[28px] mb-10 sm:text-left font-medium text-center">
              GLOBAL vision
          </h4>

          <p className="tracking-[2px] 3xl:text-left text-[13px] mb-3 font-bold text-center">
              With a remote culture, diversity is naturally in our DNA.
          </p>

          <p className="tracking-[2px] 3xl:text-left text-[13px] font-bold text-center">
